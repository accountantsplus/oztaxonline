<?php
class paypalCurl {
    //https://www.policetax.com.au/apponew/step4.php?token=6P0603086H653672C&PayerID=VPZLTUW8T72N6
    ...
    public function makePaymentURL($orderId,$name,$price,$currency,$return)
    {
