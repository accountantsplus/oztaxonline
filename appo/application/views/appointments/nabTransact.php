...
//echo $timeNdate;
//$str = "4H70010|Bdb9uV42|0|" . $testReference . "|"; //old one
...
<input type="hidden" name="EPS_AMOUNT" value="<?php echo($price);?>">
        ...
        <input type="submit" value="Continue to Complete your tax return" class="btn btn-success">
      </form>
    </div>
  </div>
...
$(document).ready(function(){
  ...
  if(package == "budget"){
    ...
    $("#product_price").append('<p><a href="packages-menu" target="_blank">Budget Tax</a> <span class="price">$' + price + '</span></p>      <hr>      <p>Total <span class="price" style="color:black"><b>$' + price + '</b></span></p>');
    ...
    var userid = getUrlParameter('sessionid');
    $("#product_price").append('<p><a href="packages-menu" target="_blank">Express Tax</a> <span class="price">$' + price + '</span></p>      <hr>      <p>Total <span class="price" style="color:black"><b>$' + price + '</b></span></p>');
    ...
    var userid = getUrlParameter('sessionid');
    $("#product_price").append('<p><a href="packages-menu" target="_blank">Standard Tax</a> <span class="price">$' + price + '</span></p>      <hr>      <p>Total <span class="price" style="color:black"><b>$' + price + '</b></span></p>');
    // $("form").append('<input type="hidden" name="EPS_AMOUNT" value="99.00">');
    $("form").append('<input type="hidden" name="EPS_RESULTURL" value="https://www.policetax.com.au/packages?packageName=' + package + '&returnval=' + userid  + '">');
  }else if(package == "premium"){
    var userid = getUrlParameter('sessionid');
    $("#product_price").append('<p><a href="packages-menu" target="_blank">Premium Plus Tax</a> <span class="price">$' + price + '</span></p>      <hr>      <p>Total <span class="price" style="color:black"><b>$' + price + '</b></span></p>');
    // $("form").append('<input type="hidden" name="EPS_AMOUNT" value="125.00">');
    $("form").append('<input type="hidden" name="EPS_RESULTURL" value="https://www.policetax.com.au/packages?packageName=' + package + '&returnval=' + userid  + '">');
  }else if(package == "rental"){
    var userid = getUrlParameter('sessionid');
    $("#product_price").append('<p><a href="packages-menu" target="_blank">Rental Plus Tax</a> <span class="price">$' + price + '</span></p>      <hr>      <p>Total <span class="price" style="color:black"><b>$' + price + '</b></span></p>');
    // $("form").append('<input type="hidden" name="EPS_AMOUNT" value="175.00">');
    $("form").append('<input type="hidden" name="EPS_RESULTURL" value="https://www.policetax.com.au/packages?packageName=' + package + '&returnval=' + userid  + '">');
  }else if(package == "soleTrader"){
  var userid = getUrlParameter('sessionid');
    $("#product_price").append('<p><a href="packages-menu" target="_blank">Sole Trader Tax</a> <span class="price">$' + price + '</span></p>      <hr>      <p>Total <span class="price" style="color:black"><b>$' + price + '</b></span></p>');
    // $("form").append('<input type="hidden" name="EPS_AMOUNT" value="195.00">');
    $("form").append('<input type="hidden" name="EPS_RESULTURL" value="https://www.policetax.com.au/packages?packageName=' + package + '&returnval=' + userid  + '">');
  }else if(package == "spouse"){
    var userid = getUrlParameter('sessionid');
    $("#product_price").append('<p><a href="packages-menu" target="_blank">Spouse/Family Tax</a> <span class="price">$' + price + '</span></p>      <hr>      <p>Total <span class="price" style="color:black"><b>$' + price + '</b></span></p>');
    // $("form").append('<input type="hidden" name="EPS_AMOUNT" value="75.00">');
    $("form").append('<input type="hidden" name="EPS_RESULTURL" value="https://www.policetax.com.au/packages?packageName=' + package + '&returnval=' + userid  + '">');
  }else if(package == "kids"){
    var userid = getUrlParameter('sessionid');
    $("#product_price").append('<p><a href="packages-menu" target="_blank">Young/Adult Tax</a> <span class="price">$' + price + '</span></p>      <hr>      <p>Total <span class="price" style="color:black"><b>$' + price + '</b></span></p>');
    // $("form").append('<input type="hidden" name="EPS_AMOUNT" value="35.00">');
    $("form").append('<input type="hidden" name="EPS_RESULTURL" value="https://www.policetax.com.au/packages?packageName=' + package + '&returnval=' + userid  + '">');
  }else if(package == "multiFix"){
    var userid = getUrlParameter('sessionid');
    $("#product_price").append('<p><a href="packages-menu" target="_blank">Multi Fix Tax</a> <span class="price">$' + price + '</span></p>      <hr>      <p>Total <span class="price" style="color:black"><b>$' + price + '</b></span></p>');
    // $("form").append('<input type="hidden" name="EPS_AMOUNT" value="195.00">');
    $("form").append('<input type="hidden" name="EPS_RESULTURL" value="https://www.policetax.com.au/packages?packageName=' + package + '&returnval=' + userid  + '">');
  }else if(package == "newRecruit"){
    var userid = getUrlParameter('sessionid');
    $("#product_price").append('<p><a href="packages-menu" target="_blank">New Recruit Tax</a> <span class="price">$' + price + '</span></p>      <hr>      <p>Total <span class="price" style="color:black"><b>$' + price + '</b></span></p>');
