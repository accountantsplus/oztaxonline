        ...
        <div class="container-fluid">
            <div class="navbar-header">
                <div id="header-logo" class="navbar-brand">
                    ...
                    <p2>153-155 Springvale Rd
                    Nunawading, VIC 3131<br>
                    Tele 1800 316 360 </p2>
            ...
            <div id="header-menu" class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <li class="app-notification dropdown">
                        <a href="dropdown-toggle menu-item" id="dropdownMenu1"  data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                        <i class="fa fa-bell" aria-hidden="true"></i>
                        </a>
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                            <li><a href="#">Current Version: V.1.0</a></li>
                            <li role="separator" class="divider"></li>
                            <li><a href="#">V.1.1 is due</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="<?= $active . $hidden ?>">
                        <a href="<?= site_url('backend/dashboard') ?>" class="menu-item" title="<?= lang('dashboard_hint') ?>">
                            <?= lang('dashboard') ?>
                        </a>
                    </li>
                    <li class="">
                        <a href="https://www.policetax.com.au/ClientLookUp/lookup.php" class="menu-item" title="Client Lookup">
                            Client Lookup
                        </a>
                    </li>
