                ...
                <fieldset>
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-7 working-plan-wrapper">
                            ...
                            <div class="form-group">
                                <label for="book-advance-timeout" class="control-label">Timeout (Hours)</label>
                                <!--<input id="book-advance-timeout" data-field="book_advance_timeout" class="form-control" type="number" min="15">-->
                                <select id="book-advance-timeout" data-field="book_advance_timeout" class="form-control">
                                </select>
                                <p class="help-block">
...
<script>
    ...
    $("#book-advance-timeout").html("");
    for(var i=1; i<=72; i++){
        var minutes = i*60;
        var option = `<option value="${minutes}">${i}</option>`;
        
        $("#book-advance-timeout").append(option);
    }
</script>