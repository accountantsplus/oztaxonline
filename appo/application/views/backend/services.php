        ...
        <div role="tabpanel" class="tab-pane active" id="services">
            <div class="row">
                ...
                <div class="record-details column col-xs-12 col-sm-5">
                    ...
                    <div class="form-group">
                        <label for="service-short-name"><?= lang('shortname') ?> *</label>
                        <input id="service-short-name" class="form-control required" maxlength="5">
                    </div>
                    ...
                    <div class="form-group">
                        <label for="service-price"><?= lang('price') ?> (each, some will have options) *</label>
