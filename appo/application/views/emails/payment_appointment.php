<html>
<head>
    <title> Tax Appointment Payment Details</title>
</head>
    ...
    <div class="email-container" style="width: 650px; border: 1px solid #eee;">
        ...
        <div id="content" style="padding: 10px 15px;">
            ...
            <table id="appointment-details">
                ...
                <tr>
                    <td class="label" style="padding: 3px;font-weight: bold;">Payment URL</td>
                    <td style="padding: 3px;"><a href="$appointment_paymenturl">Click Here</a></td>
                </tr>
                <tr>
                    <td class="label" style="padding: 3px;font-weight: bold;">Duration</td>
                    <td style="padding: 3px;">$appointment_start_date - $appointment_end_date</td>
                </tr>
            </table>
