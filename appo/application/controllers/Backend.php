...
class Backend extends CI_Controller {
    ...
    public function index($appointment_hash = '')
    {
        ...
        $view['appointments_count'] = $this->appointments_model->appointment_count();
        $view['appointments_untilToday_count'] = $this->appointments_model->appointment_untilToday_count();
        $view['appointment_Total_ThisWeek_count'] = $this->appointments_model->appointment_Total_ThisWeek_count();
        $view['appointments_untilFuture_count'] = $this->appointments_model->appointment_untilFuture_count();
