...
<body>
    ...
    <div class="form-container">
        <h1>Rental Property Expense Form</h1>
        <img src="images/rental.jpg" alt="Rental Property Example" style="width: 22%; max-width: 600px;">
        <p>Fill in the form below to tell us about your rental property situation for the 2024 tax year. We will enter it into our tax system and discuss the results with you soon. If you have an existing depreciation schedule or any other relevant information, please upload it here.</p>
