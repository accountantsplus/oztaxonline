...
class SendMail
{
    ...
    public function connect()
    {
        ...
        $mail->Port = 587;
        $mail->Priority = 1;
        $mail->Username = 'customerservice@policetax.com.au';
    ...
    public function attachClientTaxFiles($file_name)
    {
		$this->db->addAttachment("../ClientTaxFiles/".$file_name);
    }
    public function attachMailTemplates($file_name)
    {
		$this->db->addAttachment("../MailTemplates/".$file_name);
    }
