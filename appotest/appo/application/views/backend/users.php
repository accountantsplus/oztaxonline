            ...
            <div class="row">
                ...
                <div class="record-details column col-xs-12 col-sm-7">
                    ...
                    <div class="switch-view pull-right">
                        ...
                        <div class="display-user-account"><?= lang('account_details') ?></div>
                        ...
                        <div class="row">
                            <div class="provider-details col-xs-12 col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="checkbox" id="is-main" name="is-main" >
                                </div>
                                ...
                                <div id="provider-services-linkedAccount" class="well"></div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="provider-zip-code"><?= lang('post_code') ?></label>
                                    <input id="provider-zip-code" class="form-control" maxlength="64">
                                </div>

                                <div class="form-group">
                                    <label for="provider-displayName">Display Name</label>
                                    <input id="provider-displayName" class="form-control" maxlength="300">
                                </div>
                    ...
                    <div class="user-account-view provider-view" style="display: none;">
                ...
                <div class="record-details column col-xs-12 col-sm-7">
                    ...
                    <div class="row">
                        <div class="secretary-details col-xs-12 col-sm-6">
                            ...
                            <div class="form-group">
                                <label for="secretary-zip-code"><?= lang('post_code') ?></label>
                ...
                <div class="record-details column col-xs-12 col-sm-7">
                    ...
                    <div class="row">
                        <div class="admin-details col-xs-12 col-sm-6">
                            ...
                            <div class="form-group">
                                <label for="admin-zip-code"><?= lang('post_code') ?></label>
