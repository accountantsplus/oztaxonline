...
var JqueryUiTheme = Theme.extend({
	...
	classes: {
		...
		wigetContextend: 'fc-content-symbol',
		buttonGroup: 'fc-button-group',
		button: 'ui-button',
			...
			'>' +
				'<div class="fc-content">' +
					...
					(eventDef.title ?
						...
						(eventDef.title != "Break" && eventDef.title != "Not Working" ?
							'<i style="margin-right: 2px; color: orange;" class="pull-right glyphicon glyphicon-pencil"></i>' :
							''
							)  +
				'</div>' +
				'<div class="fc-bg"/>' +
