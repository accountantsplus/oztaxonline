...
if($submit == "CreditCardSubmit"){
    $validity = $_POST['validity'];
    $hasValidTime = $_POST['hasValidTime'];
    $processed = $_POST['processed'];
    if($hasValidTime == "1"){
        
        $sql = "UPDATE " . $table . " SET HasCreditCardEmail = '1', ValidationCode = '" . $validity . "', ValidationLifeline = '" . $NewDate . " " . date("h:i:sa") . "', ModifiedDate = '" . date("d/m/Y") . " " . date("h:i:sa") . "' where Id='" . $id . "'";
    }
    
    if($processed == "true"){
        $sql = "UPDATE " . $table . " SET HasProcessed = '1', ModifiedDate = '" . date("d/m/Y") . " " . date("h:i:sa") . "' where Id='" . $id . "'";
    }
}
