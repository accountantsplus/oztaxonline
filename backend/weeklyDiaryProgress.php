...
<head>
  ...
  <title>Weekly Diary Progress | AccountantsPlus</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Weekly Progress - Diary</li>
      </ol>
    </section>
...
<script>
    ...
    $(function () {
        ...
        var getValue = function(){
            ...
            $.post("weekData_Diary", {occupation: occVal, filter: filterVal, years: parseInt($(".year-data :selected").val())}, function(response){
