(function($) {
    ...
    var package = "";
    var additionalDeduction = 0;
    var price = 99;
    var isValidSecondButtonHide = 0;
    ...
    $("#signup-form").append("<input type='hidden' id='isValidSecondButtonHide' value='0' />")

    var packageName = getUrlParameter('packageName');
    $.get("price", function(response){
        response = JSON.parse(response);
        if(response.success == 'true'){
            $.each(response.aaData, function(i, v){
                if(v.FieldName.toLowerCase().indexOf("budget") != -1 && packageName == "budget"){
                    price = v.FieldValues;
                } else if(v.FieldName.toLowerCase().indexOf("express") != -1 && packageName == "express"){
                    price = v.FieldValues;
                } else if(v.FieldName.toLowerCase().indexOf("standard") != -1 && packageName == "standard"){
                    price = v.FieldValues;
                } else if(v.FieldName.toLowerCase().indexOf("premium") != -1 && packageName == "premium"){
                    price = v.FieldValues;
                } else if(v.FieldName.toLowerCase().indexOf("rental") != -1 && packageName == "rental"){
                    price = v.FieldValues;
                } else if(v.FieldName.toLowerCase().indexOf("soletrader") != -1 && packageName == "soleTrader"){
                    price = v.FieldValues;
                } else if(v.FieldName.toLowerCase().indexOf("kids") != -1 && packageName == "kids"){
                    price = v.FieldValues;
                } else if(v.FieldName.toLowerCase().indexOf("spouse") != -1 && packageName == "spouse"){
                    price = v.FieldValues;
                } else if(v.FieldName.toLowerCase().indexOf("newrecruit") != -1 && packageName == "newRecruit"){
                    price = v.FieldValues;
                } else if(v.FieldName.toLowerCase().indexOf("multifix") != -1 && packageName == "multiFix"){
                    price = v.FieldValues;
                }
            });
        }
    ...
    if(packageName == "standard"){
        ...
        //price = 99;
        limitEmployer = 1;
        $("#add-employers").parent().show();
        $("#additional-tax-deduction").parent().parent().show();
        $("#more-additional-tax-deduction").parent().parent().hide();
        $("#rental-tax-deduction").parent().parent().hide();
        $("#soleTrader-tax-deduction").parent().parent().hide();
        $(".occupation-normal").hide();
        $(".occupation-police").show();
        $(".add-emp").parent().prepend('<span style="text-align: center;color: red;">Only 3 group certificates are allowed. If you have more than that use Premium Plus product.</span><br/><br/>');
    } else if(packageName == "express"){
        package = "Express";
        limitEmployer = 0;
        //price = 69;
        $("#additional-tax-deduction").parent().parent().hide();
        $("#more-additional-tax-deduction").parent().parent().hide();
        $("#rental-tax-deduction").parent().parent().hide();
        $("#soleTrader-tax-deduction").parent().parent().hide();
        $("#add-employers").parent().hide();
        $(".occupation-normal").hide();
        $(".occupation-police").show();
        ...
        $("#add-employers").parent().show();
        $("#additional-tax-deduction").parent().parent().show();
        $("#more-additional-tax-deduction").parent().parent().show();
        $("#rental-tax-deduction").parent().parent().hide();
        $("#soleTrader-tax-deduction").parent().parent().hide();
        $(".occupation-normal").hide();
        $(".occupation-police").show();
    } else if(packageName == "rental"){
        package = "Rental Plus";
        limitEmployer = 20;
        //price = 175;
        $("#add-employers").parent().show();
        $("#additional-tax-deduction").parent().parent().show();
        $("#rental-tax-deduction").parent().parent().show();
        $("#more-additional-tax-deduction").parent().parent().hide();
        $("#soleTrader-tax-deduction").parent().parent().hide();
        $(".occupation-normal").hide();
        $(".occupation-police").show();
    } else if(packageName == "soleTrader"){
        package = "Sole Trader";
        limitEmployer = 20;
        //price = 195;
        $("#add-employers").parent().show();
        $("#additional-tax-deduction").parent().parent().show();
        $("#soleTrader-tax-deduction").parent().parent().show();
        $("#more-additional-tax-deduction").parent().parent().hide();
        $("#rental-tax-deduction").parent().parent().hide();
        $(".occupation-normal").hide();
        $(".occupation-police").show();
    } else if(packageName == "multiFix"){
        package = "Multi Fix";
        limitEmployer = 0;
        //price = 195;
        $("#additional-tax-deduction").parent().parent().hide();
        ...
        $(".occupation-normal").hide();
        $(".occupation-police").show();
    } else if(packageName == "spouse"){
        package = "Spouse/Family";
        limitEmployer = 0;
        //price = 75;
        $("#additional-tax-deduction").parent().parent().hide();
        $("#more-additional-tax-deduction").parent().parent().hide();
        ...
        $("#soleTrader-tax-deduction").parent().parent().hide();
        $("#add-employers").parent().hide();
        $(".occupation-normal").show();
        $(".occupation-police").hide();
        ...
        $(".occupation-normal").show();
        $(".occupation-police").hide();
    } else if(packageName == "newRecruit"){
        package = "New Recruit";
        limitEmployer = 0;
        //price = 155;
        $("#additional-tax-deduction").parent().parent().hide();
    ...
    $("#packageName").val(package + " Tax");
    $(".title_center").find("h1 p").text(package + " Tax");
        ...
        form.children("div").steps({
            ...
            onStepChanging: function(event, currentIndex, newIndex) {
                ...
                if (currentIndex === 1) {
                    ...
                    if(creditcardInfo == 1 && parseInt($("#isValidSecondButtonHide").val()) == 0){
                        $("#steps-uid-0").find(".actions").find("a[href='#next']").hide();
                    }
        ...
        form.children("div").steps({
            ...
            onFinishing: function(event, currentIndex) {
                ...
                grecaptcha.enterprise.ready(function() {
                  grecaptcha.enterprise.execute('6LeIoUMnAAAAAP8JiDM_bnNARH2KXbLxCTlF3Jdu', {action: 'submit'}).then(function(token) {
                    form.validate().settings.ignore = ":disabled";
                    return form.valid();
                  });
                });
    ...
    $.dobPicker({
        daySelector: '#rental_date',
        monthSelector: '#rental_month',
        yearSelector: '#rental_year',
        dayDefault: '',
        monthDefault: '',
        yearDefault: '',
        minimumAge: 0,
    ...
    var emailCustomerService = function(salutationAndName){
        ...
        paymentMessage += '</tr><tr><td class="label">Account Name</td><td class="value">AV00010</td></tr><tr><td class="label">Trading Name</td><td class="value">Accountants Plus</td></tr><tr><td class="label">Receipt Number</td><td class="value">721</td></tr><tr><td class="label">Payment Amount</td>';
        ...
        paymentMessage += '</tr><tr><td class="threecolvalue">' + package + ' Tax | PoliceTax</td>';
        ...
        paymentEmail.append("subject", "Payment Receipt | " + package + " Tax | " + salutationAndName );
        //paymentEmail.append("emailTo", "creditcard@policetax.com.au");
        paymentEmail.append("emailTo", "policetax0@gmail.com");
        paymentEmail.append("TFN", $("#my-tfn").val());
        paymentEmail.append("TaxType", package);
        ...
        $.post("getData", {returnid: valId}, function(response){
            response = JSON.parse(response);
            ...
            if(response[0] == "true"){
                ...
                if(jsondata == 0){
                    ...
                    continuation += "<span><a href='https://www.policetax.com.au/packages?packageName=" + packageName + "&returnval=" + valId + "&txnid=" + txnid + "&summarycode=1&validity=" + validityVal + "'>Click Here</a> </span> <br /><br />";
                    ...
                    continuationURL.append("TaxType", package);
    ...
    var getRequiredValue = function(data){
        ...
        $.post("getData", {returnid: data}, function(response){
            response = JSON.parse(response);
                ...
                $.each(jsondata, function(i, v){
                    if(i == "BeenWithUsBefore"){
                        ...
                        if(v != ""){ 
                            ...
                            // }
                            $("#birth_date").val(datepickerVal[0]);
                            $("#birth_month").val(datepickerVal[1]);
                            $("#birth_year").val(datepickerVal[2]); 
                        }
                    }
                    else if(i == "TFN"){
                        $("#my-tfn").val(v);
                        ...
                        if(v != ""){ 
                            ...
                            //     datepickerVal[2] = singleVal[1];
                            // }
                            $("#spousebirth_month").val(datepickerVal[1]);
                            $("#spousebirth_date").val(datepickerVal[0]); 
                            $("#spousebirth_year").val(datepickerVal[2]);
                        }
                    }
                        ...
                        if(v != ""){ 
                            ...
                            //     datepickerVal[2] = singleVal[1];
                            // }
                            $("#spouseFullYear_month").val(datepickerVal[1]);
                            $("#spouseFullYear_date").val(datepickerVal[0]); 
                            $("#spouseFullYear_year").val(datepickerVal[2]);
                        }
                    }
    ...
    function startFunction(){
        ...
        if(data[0] != undefined && data != ""){
            ...
            if(summaryCode == "1"){
                ...
                $.post("editData", {id: getUrlParameter('returnval'), from: "confirmPayment", bankid: getUrlParameter('txnid')}, function(response){
                            ...
                            if(response[0] == "true"){
                                ...
                                if(parseInt(validityCode) == parseInt(validity.validity)){
                                    if(parseInt(totalclientDate[2]+totalclientDate[1]+totalclientDate[0]) > parseInt(serverDate)){
                                        ...
                                        //window.location.href = "https://www.policetax.com.au/new-express-tax;
                                        return;
                                    }
                                }else{
                                    if(window.confirm("The validity of this link has expired. Please contact PoliceTax for further assistance.")){
                ...
                window.location.href = "https://www.policetax.com.au/nabTransact?package=" + packageName + "&sessionid=" + getUrlParameter('returnval');
                return;
            }
    ...
    $(".more-agreed-btn").on("click", function(e){
        e.preventDefault();
        checkkms = 1;
        $('#myModalMoreAdditionalDeduction').modal("hide");
    });
    ...
    function addPayG() {
        ...
        var sumOfAllPayGTax = val1 + dynamicVal;
        // console.log("All Income: " + sumOfAllIncome);
        // ansA.value = roundToDecimalDigits(sumOfAllIncome);
        // taxIncome();
    ...
    function addRESCSuper(){
        ...
        // var ansA = document.getElementById("answer1");
        var sumOfAllRESCSuper = val1 + dynamicVal;
        // console.log("All Income: " + sumOfAllIncome);
        // ansA.value = roundToDecimalDigits(sumOfAllIncome);
        // taxIncome();
    ...
    function addRFBT() {
        ...
        // var ansA = document.getElementById("answer1");
        var sumOfAllRFBT = val1 + dynamicVal;
        // console.log("All Income: " + sumOfAllIncome);
        // ansA.value = roundToDecimalDigits(sumOfAllIncome);
        // taxIncome();
    ...
    var validate = function(modals){
        if(modals == "popUpVisitor"){
            ...
            if($("#Employer1 option:selected").val() == ""){
              ...
              emp1.focus();
              $("#myModalAddEmployers").modal("hide");
              $.each($(".emp-data"), function(i, v){
                $(this).remove();
                addNumbers();
              });
            ...
            if ($("#HereBefore option:selected").val() == ""){
                ...
                notify('white', "Please select if you have been with us before.");
                $("#HereBefore").focus();
                return false;
            }
        ...
        var spouseWantsTaxDone = $("#spouseWantsTaxDone");
        var taxableIncome = document.getElementById("taxableincome");
        var spousebirth_date = $("#spousebirth_date option:selected").val();
        var spousebirth_month = $("#spousebirth_month option:selected").val();
        var spousebirth_year = $("#spousebirth_year option:selected").val();
        var spouseFullYear_date = $("#spouseFullYear_date option:selected").val();
        var spouseFullYear_month = $("#spouseFullYear_month option:selected").val();
        var spouseFullYear_year = $("#spouseFullYear_year option:selected").val();
        var myDob_date = $("#birth_date option:selected").val();
        var myDob_month = $("#birth_month option:selected").val();
        var myDob_year = $("#birth_year option:selected").val();
        var myDob = myDob_date + "/" + myDob_month + "/" + myDob_year;
        var spouseBirthDate = spousebirth_date + "/" + spousebirth_month + "/" + spousebirth_year;
        var spouseFullYears = spouseFullYear_date + "/" + spouseFullYear_month + "/" + spouseFullYear_year;

        if($("#HaveSpouse").is(':checked')){

            if (!validateAlphabet(spouseFirstname.value)) {
                $("#isValidSecondButtonHide").val("1");
                notify('white', "Please enter alphabets only for the First Name.");
                spouseFirstname.focus();
                return false;
            }
            ...
            if (spousebirth_date == "" || spousebirth_month == "" || spousebirth_year == "") {
                $("#isValidSecondButtonHide").val("1");
                notify('white', "Please Select Spouse Date of Birth");
                spousebirth_date.focus();
                // salr1.attr("aria-invalid", true); // add invalid aria
                return false;
            }
            ...
            if($("#QspouseForFullYear option:selected").val() == "No"){    
                if (spouseFullYear_date == "" || spouseFullYear_month == "" || spouseFullYear_year == "") {
                    $("#isValidSecondButtonHide").val("1");
                    notify('white', "Please Select Spouse Start Date");
                    spouseFullYear_date.focus();
                    // salr1.attr("aria-invalid", true); // add invalid aria
                    return false;
                }
            }
        ...
        if (!validateNumber(mytfn.value, 9)) {
            ...
            notify('white', "Please do not include '-' or space in between the numbers.");
            mytfn.focus();
            return false;
        }
        ...
        if(creditcardInfo == 1){
            ...
            var jsonData = {
                ...
                Email: $("#email").val(),
                ContactBy: $("select[name='ContactBy'] option:selected").val(),
                ...
                SpouseStartDate: spouseFullYears,
            ...
            $.post("test_db", {userdata: JSON.stringify(jsonData)}, function(response){
                response = JSON.parse(response);
                if(response[0] == "true"){
                    var id = response[1];
                    window.location.href = "nabTransact?package=" + packageName + "&sessionid=" + id;
                }
            });
            return;
        }
        ...
        var valId = getUrlParameter('returnval');
        $.post("editData", {id: valId, from: "ExpenseSubmit"}, function(response){
        ...
        return true;
            ...
            var message = "<html><title></title><body><span style='background-color: black;color:black;'><h4>Profile</h4></span>\n";
                ...
                if(i.indexOf("taxDedcutionExpenseSubstantiation") != -1 || i.indexOf("agreed-on") != -1 || i.indexOf("termsandcondition") != -1
                    ...
                    if(v == 0 || v == "select"){
                        if(i.indexOf("CarKms") != -1){
                            if(carkm == 0){
                                message += "<br/><span style='background-color: black;color:black;'><h4>D1 Car Kms</h4></span> \n";
                                carkm += 1;
                            }
                        ...
                        if(i.indexOf("Employer1") != -1){
                            $.each($(".tax-question-checkbox"), function(i, v){
                                ...
                                if(i <= 11){
                                    if(i == 0){
                                        message += " <br/><span style='background-color: black;color:black;'><h4>Tax Questions </h4></span>\n";
                                        message += " <br/><span style='background-color: black;color:black;'><h4>3 Main Tax Questions </h4></span>\n";
                                    }
    
                                    if(i == 3){
                                        message += " <br/><span style='background-color: black;color:black;'><h4>Other Tax Questions </h4></span>\n";
                                    }
                        ...
                        if(i.indexOf("agreed-on") != -1 || i.indexOf("taxDeductionExpenseSubsantian") != -1 || i.indexOf("noteForAccountant") != -1){
                            if(taxHeader == 0){
                                message += " <br/><span style='background-color: black;color:black;'><h4>Terms and Conditions Agreed / Electronic signed tax return</h4></span>\n";
                                taxHeader += 1
                            }
                        }
                        ...
                        if(i.indexOf("allDeductions") != -1){
                            message += " <br/><span style='color:black;'><h4>--------- Deductions ----------- </h4></span>\n";
                        }

                        if(i.indexOf("mobile-telephone") != -1){
                            message += "<br/><span style='color:black;'><h4>Contact Details </h4></span>\n";
                        }
            ...
            $.post("editData", {id: valId, filemakerData: JSON.stringify(listData), from: "submit"}, function(response){
    ...
    $("#add-employers").on("click", function(e){
        e.preventDefault();
        $("#myModalAddEmployers").modal();

        if(tableNumber == 1){
          var table_row = "<tr class='" +    tableNumber + "_employer emp-data'>";
          table_row += '<td><input type="text" placeholder="Employer Name" id="employer_' +    tableNumber + '" class="employer" value="" onclick="$(this).focus(); $(this).select();$(this).get(0).setSelectionRange(0,9999);" autofocus/></td>';
          table_row += '<td><input type="number" id="salary_' +    tableNumber + '" class="addNumbers" class="employer" value="0" onclick="$(this).focus(); $(this).select();$(this).get(0).setSelectionRange(0,9999);" /></td>';
          table_row += '<td><input type="number" id="allow_' +    tableNumber + '" class="addNumbers" class="employer" value="0" onclick="$(this).focus(); $(this).select();$(this).get(0).setSelectionRange(0,9999);" /></td>';
          table_row += '<td><input type="number" id="payg_' +    tableNumber + '" class="addPayG" class="employer" value="0" onclick="$(this).focus(); $(this).select();$(this).get(0).setSelectionRange(0,9999);" /></td>';
          table_row += '<td><input type="number" id="resc_' +    tableNumber + '" class="addRESCSuper" class="employer" value="0" onclick="$(this).focus(); $(this).select();$(this).get(0).setSelectionRange(0,9999);" /></td>';
          table_row += '<td><input type="number" id="rfbt_' +    tableNumber + '" class="addRFBT" class="employer" value="0" onclick="$(this).focus(); $(this).select();$(this).get(0).setSelectionRange(0,9999);" /></td>';
          table_row += '<td><button class="cancel-emp" style="cursor: pointer;width: 72px;font-size: 11px;">';
    ...
    $(".agreed-btn").on("click", function(e){
        ...
        $("#myModalAdditionalDeduction").modal("hide");
    });

    $("#additional-tax-deduction").on("click", function(e){
        e.preventDefault();
        $("#myModalAdditionalDeduction").modal();
    });

    $("#more-additional-tax-deduction").on("click", function(e){
        e.preventDefault();
        $("#myModalMoreAdditionalDeduction").modal();
        $("body").prepend("<input type='hidden' id='additional-tax-deduction-notice' value='1' />");
    });

    $("#rental-tax-deduction").on("click", function(e){
        e.preventDefault();
        $("#myModalRentalPlusDeduction").modal();
    });
    
    $(".rental-agreed-btn").on("click", function(e){
        e.preventDefault();
        $("#myModalRentalPlusDeduction").modal('hide');
    });

    $("#soleTrader-tax-deduction").on("click", function(e){
        e.preventDefault();
        $("#myModalSoleTraderDeduction").modal();
    });
    
    $(".soleTrader-agreed-btn").on("click", function(e){
        e.preventDefault();
        $("#myModalSoleTraderDeduction").modal('hide');
    });

    
    //Rental Deductions and Income calculations
    $(".income-data").keypress(function(){
        var incomeVal = 0;
        $.each($(".income-data"), function(i, v){
          if($(this).val() === null || $(this).val() == ""){
            incomeVal += 0;
          }else{
            incomeVal += parseInt($(this).val());
          }
        });
        if(incomeVal == ""){
          incomeVal = 0;
        ...
        var expenseVal = parseInt($("#item46_totalExpense").val());
        $("#grossrentIncome").val(incomeVal);
        $("#item49_NetRent").val(incomeVal - expenseVal);
        taxIncome();
    });

    $(".income-data").keyup(function(){
        var incomeVal = 0;
        $.each($(".income-data"), function(i, v){
            if($(this).val() === null || $(this).val() == ""){
            incomeVal += 0;
    ...
    $(".expense-data").keypress(function(){
        var expenseVal = 0;
        $.each($(".expense-data"), function(i, v){
            if($(this).val() === null || $(this).val() == ""){
            expenseVal += 0;
            }else{
            expenseVal += parseInt($(this).val());
            }
        });
        if(expenseVal == ""){
            expenseVal = 0;
        ...
        var incomeVal = parseInt($("#grossrentIncome").val());
        $("#item46_totalExpense").val(expenseVal);
        $("#item49_NetRent").val(incomeVal - expenseVal);
        taxIncome();
    });

    $(".expense-data").keyup(function(){
        var expenseVal = 0;
        $.each($(".expense-data"), function(i, v){
            if($(this).val() === null || $(this).val() == ""){
            expenseVal += 0;
    ...
    //Sole Trader Deductions and Income calculations
    $(".income-data-soleTrader").keypress(function(){
        var incomeVal = parseInt($(this).val());
        if(incomeVal == ""){
          incomeVal = 0;
        }
  
        var expenseVal = parseInt($("#item46_lessExpense").val());
        $("#item49_TotalBusinessIncomeLoss").val(incomeVal - expenseVal);
        taxIncome();
    });
  
    $(".income-data-soleTrader").keyup(function(){
        var incomeVal = parseInt($(this).val());
        if(incomeVal == ""){
          incomeVal = 0;
        }
    ...
    $(".expense-data-soleTrader").keypress(function(){
        var expenseVal = 0;
        $.each($(".expense-data-soleTrader"), function(i, v){
          if($(this).val() === null || $(this).val() == ""){
            expenseVal += 0;
          }else{
            expenseVal += parseInt($(this).val());
        ...
        var incomeVal = parseInt($("#income-sales").val());
        $("#item46_lessExpense").val(expenseVal);
        $("#item49_TotalBusinessIncomeLoss").val(incomeVal - expenseVal);
        taxIncome();
    });
  
    $(".expense-data-soleTrader").keyup(function(){
        var expenseVal = 0;
        $.each($(".expense-data-soleTrader"), function(i, v){
          if($(this).val() === null || $(this).val() == ""){
            expenseVal += 0;
    ...
    $('a[href="#finish"]').on("click", function(e){
            ...
            callback: function () {
                if($("#valueAdded").val() == "0"){
                    ...
                    $.post("editData", {id: valId, filemakerData: JSON.stringify(listData), from: "submit"}, function(response){
                        ...
                        window.location.href = "https://www.policetax.com.au/online-tax-completed";
                    });
                }
            }
        ...
        $.each(formData, function(i, v){
            ...
            || i.indexOf("checkTerms ") != -1){
                ...
                if(v == 0 || v == "select"){
                ...
                } else if(i.indexOf("birth_date") != -1 || i.indexOf("birth_month") != -1 || i.indexOf("birth_year") != -1){
                    if(i.indexOf("birth_date") != -1){
                        birthDate += v + "/";
                    }else if(i.indexOf("birth_month") != -1){
                        birthDate += v + "/";
                    }else if(i.indexOf("birth_year") != -1){
                        birthDate += v;
                    
                        i = "Date of Birth";
        
                        message += i + " : " + birthDate + "<br/>\n";
                    }
                } else if(i.indexOf("spousebirth_date") != -1 || i.indexOf("spousebirth_month") != -1 || i.indexOf("spousebirth_year") != -1){
                    if(i.indexOf("spousebirth_date") != -1){
                        spousebirthDate += v + "/";
                    }else if(i.indexOf("spousebirth_month") != -1){
                        spousebirthDate += v + "/";
                    }else if(i.indexOf("spousebirth_year") != -1){
                        spousebirthDate += v;
                        i = "Spouse Date of Birth";
        
                        message += i + " : " + spousebirthDate + "<br/>\n";
                    }
                    
                } else if(i.indexOf("spouseFullYear_month") != -1 || i.indexOf("spouseFullYear_date") != -1 || i.indexOf("spouseFullYear_year") != -1){
                    if(i.indexOf("spouseFullYear_date") != -1){
                        spouseFullYearDate += v + "/";
                    }else if(i.indexOf("spouseFullYear_month") != -1){
                        spouseFullYearDate += v + "/";
                    }else if(i.indexOf("spouseFullYear_year") != -1){
                        spouseFullYearDate += v;
                        i = "Spouse Start Date for the Year";
                        message += i + " : " + spouseFullYearDate + "<br/>\n";
                    }
                    
                } else if(i.indexOf("mobile-used") != -1){
                        message += "<span style='background-color: black;color:black;'><h4>D5.11 Mobile Used for Work Purposes </h4></span> <br/>\n";
                        
                        if(v == "on"){
                            
                            message += "Mobile Used : Yes <br/>\n";
                            listData[i] = "Yes";
                        }else{
                            
                            message += "Mobile Used : No <br/>\n";
                            listData[i] = "No";
                        }
                } else if(i.indexOf("internet-used") != -1){
                        message += "<span style='background-color: black;color:black;'><h4>D5.12 Internet Used for Work Purposes</h4></span> <br/>\n";
                        
                        if(v == "on"){
                            
                            message += "Internet Used : Yes <br/>\n";
                            listData[i] = "Yes";
                        }else{
                            
                            message += "Internet Used : No <br/>\n";
                            listData[i] = "No";
                        }
                        hasInternet = 1;
                }else{
                    if(i.indexOf("Tax Year") != -1){
                        subject += v + " PoliceTax | " + package + " Tax - ";
                    }
                    ...
                    if(i.indexOf("Employer1") != -1){
                        $.each($(".tax-question-checkbox"), function(i, v){
                            ...
                            if(i == 0){
                                    message += "<span style='background-color: black;color:black;'><h4>3 Main Tax Questions </h4></span> <br/>\n";
                            }
                    ...
                    if(i.indexOf("my-tfn") != -1){
                        message += " <br/><span style='background-color: black;color:black;'><h4>Tax Credentials</h4></span>\n";
                    }
                    ...
                    if(i.indexOf("internet_monthly_plan_cost") != -1){
                        if(hasInternet = 0){
                            message += " <br/><span style='background-color: black;color:black;'><h4>D5.12 Internet Used for Work Purposes</h4></span>\n";
                        }
                    }
        ...
        clientMessage += "<span>We have received your payment of <b>$" + price + "</b> for the " + package + " Tax. </span> <br />";
        ...
        clientEmail.append("TaxType", package);
        ...
        form_data.append("emailTo", "policetax0@gmail.com");
        form_data.append("TFN", $("#my-tfn").val());
        //console.log(data);
        var sendData = window.sendData(listData, "");
        if(sendData){
