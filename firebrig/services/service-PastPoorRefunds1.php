...
<body>
    ...
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url(../assets/img/breadcrumb/01.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Past Poor Refunds</h2>
                <ul class="breadcrumb-menu">
                    <li><a href="index.html">Home</a></li>
                    <li class="active">Past Poor Refunds</li>
                </ul>
            </div>
        </div>
        <!-- breadcrumb end -->
                    ...
                    <div class="row">
                            ...
                            <div class="service-sidebar">
                                <div class="widget category">
                                    ...
                                    <div class="category-list">
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Fire Fighting</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Operation Force</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Fire Suppression</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Ambulance Service</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Fire Investigation</a>
                                        <a href="#"><i class="far fa-long-arrow-right"></i>Community Safety</a>
                                    </div>
                                </div>
                        ...
                        <div class="col-xl-8 col-lg-8">
                            <div class="service-details">
                                ...
                                <div class="service-details">
                                    <h3 class="mb-20">Fire Suppression</h3>
                                    <p class="mb-20">
