...
<body>
    ...
    <div class="form-container">
        <h1>Police work related deductions proforma template Form<br><br>(for Office use only) </h1>
        <img src="images/rental.jpg" alt="Rental Property Example" style="width: 22%; max-width: 600px;">
        <p>Fill in the form below <B>ABOUT YOUR WORK RELATED DEDUCTIONS</B> to tell us about your rental property situation for the 2024 tax year. We will enter it into our tax system 
